...
output_dir = r'G:\IIT_AI work\ISRAEL\GWS_Model info\Data and feature score\Revised data and feature_fitting scores\Final results (dataset_28.8)\Israel model run\XGBoost_country_final_single_run1'  #used in my case
...
excelFilePath = r'G:\IIT_AI work\ISRAEL\GWS_Model info\Data and feature score\Revised data and feature_fitting scores\Dataset_to_share.xlsx'  #This path used in my case
...
# =============================================
# SINGLE RUN TRAINING FUNCTION WITH XGBOOST
# =============================================

def train_single_run_with_density_weights(X, y, selected_columns, basin_densities, random_state=42):
    """
    Train XGBoost model on a single run with basin density weighting using inverse square-root method
    """
    ...
    print("Training XGBoost model with basin density weights...")
    model = XGBRegressor(
        n_estimators=200,
        random_state=random_state,
        learning_rate=0.05,
    ...
    additional_metrics = create_actual_vs_predicted_plot(
        y_test, y_pred, metrics_dict, single_run_dir, "XGBoost"
    )
    ...
    # Additional XGBoost specific diagnostics
...
# =============================================
# MAIN EXECUTION - SINGLE RUN WITH XGBOOST
# =============================================

if __name__ == "__main__":
    print("Starting single run with XGBoost and basin density weighting...")
    print("=" * 60)
